...
```bash
npm --prefix /home/inovatica/seal/monorepo/tools/fleet-manager/apps/robokit-proxy start
```

Profile example:

```bash
PROXY_PROFILE=local npm --prefix /home/inovatica/seal/monorepo/tools/fleet-manager/apps/robokit-proxy start
```
...
```bash
npm --prefix /home/inovatica/seal/monorepo/tools/fleet-manager/apps/robokit-proxy run e2e
```

By default it reads:
- `/home/inovatica/seal/monorepo/tools/fleet-manager/apps/robokit-proxy/config.json5`

Override with:

```bash
CONFIG_PATH=/path/to/config.json5 npm --prefix /home/inovatica/seal/monorepo/tools/fleet-manager/apps/robokit-proxy start
```
