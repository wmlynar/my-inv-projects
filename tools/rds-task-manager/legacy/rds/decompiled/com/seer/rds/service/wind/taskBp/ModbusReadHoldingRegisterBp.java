 ...
 *  com.seer.rds.service.wind.taskBp.ModbusReadHoldingRegisterBp
...
import com.seer.rds.vo.wind.ModbusReadHoldingRegisterBpField;
...
@Component(value="ModbusReadHoldingRegisterBp")
@Scope(value="prototype")
public class ModbusReadHoldingRegisterBp
extends AbstractBp {
    private static final Logger log = LoggerFactory.getLogger(ModbusReadHoldingRegisterBp.class);
    @Autowired
    ...
    protected void getInputParamsAndExecute(AbstratRootBp rootBp) throws Exception {
        this.ipModbusHost = String.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusReadHoldingRegisterBpField.ipModbusHost));
        this.ipModbusPort = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusReadHoldingRegisterBpField.ipModbusPort).toString());
        this.ipRegisterAddress = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusReadHoldingRegisterBpField.ipRegisterAddress).toString());
        this.ipSlaveId = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusReadHoldingRegisterBpField.ipSlaveId).toString());
        ...
        while (true) {
            try {
                ...
                modbusValue = Modbus4jUtils.readHoldingRegister((String)this.ipModbusHost, (int)this.ipModbusPort, (int)this.ipSlaveId, (int)this.ipRegisterAddress, (int)2, (String)"ModbusReadHoldingRegisterBp");
            }
            catch (Exception e) {
                ...
                log.error("ModbusReadHoldingRegisterBp [{},{}] {}]", new Object[]{this.ipModbusHost, this.ipModbusPort, e});
                ...
                if (!modbusException) {
                    ...
                    this.windService.updateTaskRecordEndedReason(this.taskRecord.getId(), "[ModbusReadHoldingRegisterBp]modbus @{wind.bp.retry}");
                }
        ...
        log.info("ModbusReadHoldingRegisterBp " + message);
        ...
        childParamMap.put(ModbusReadHoldingRegisterBpField.ctxModbusValue, modbusValue);
    ...
    protected void setBlockInputParamsValue(AbstratRootBp rootBp) throws Exception {
        ModbusReadHoldingRegisterBp bpData = new ModbusReadHoldingRegisterBp();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ModbusReadHoldingRegisterBp)) {
            return false;
        }
        ModbusReadHoldingRegisterBp other = (ModbusReadHoldingRegisterBp)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ModbusReadHoldingRegisterBp;
    }
    ...
    public String toString() {
        return "ModbusReadHoldingRegisterBp(windService=" + this.getWindService() + ", windTaskRecordMapper=" + this.getWindTaskRecordMapper() + ", ipModbusHost=" + this.getIpModbusHost() + ", ipModbusPort=" + this.getIpModbusPort() + ", ipRegisterAddress=" + this.getIpRegisterAddress() + ", ipSlaveId=" + this.getIpSlaveId() + ")";
    }
}
