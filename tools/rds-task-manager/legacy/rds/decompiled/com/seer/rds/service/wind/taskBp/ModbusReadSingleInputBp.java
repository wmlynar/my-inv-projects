 ...
 *  com.seer.rds.service.wind.taskBp.ModbusReadSingleInputBp
...
import com.seer.rds.vo.wind.ModbusReadSingleInputBpField;
...
@Component(value="ModbusReadSingleInputBp")
@Scope(value="prototype")
public class ModbusReadSingleInputBp
extends AbstractBp {
    private static final Logger log = LoggerFactory.getLogger(ModbusReadSingleInputBp.class);
    @Autowired
    ...
    protected void getInputParamsAndExecute(AbstratRootBp rootBp) throws Exception {
        this.ipModbusHost = String.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusReadSingleInputBpField.ipModbusHost));
        this.ipModbusPort = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusReadSingleInputBpField.ipModbusPort).toString());
        this.ipCoilAddress = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusReadSingleInputBpField.ipCoilAddress).toString());
        this.ipSlaveId = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusReadSingleInputBpField.ipSlaveId).toString());
        ...
        while (true) {
            try {
                ...
                modbusValue = Modbus4jUtils.readInputStatus((String)this.ipModbusHost, (int)this.ipModbusPort, (int)this.ipSlaveId, (int)this.ipCoilAddress, (String)"ModbusReadSingleInputBp");
            }
            catch (Exception e) {
                ...
                log.error("ModbusReadSingleInputBp [{},{}] {}]", new Object[]{this.ipModbusHost, this.ipModbusPort, e});
                ...
                if (!modbusException) {
                    ...
                    this.windService.updateTaskRecordEndedReason(this.taskRecord.getId(), "[ModbusReadSingleInputBp]modbus @{wind.bp.retry}");
                }
        ...
        message.append("ipModbusHost=").append(this.ipModbusHost).append(",ipModbusPort=").append(this.ipModbusPort).append(",ipCoilAddress=").append(this.ipCoilAddress).append(",ipSlaveId=").append(this.ipSlaveId).append(",modbusValue=").append(modbusValue);
        log.info("ModbusReadSingleInputBp " + message);
        ...
        childParamMap.put(ModbusReadSingleInputBpField.ctxModbusValue, modbusValue);
    ...
    protected void setBlockInputParamsValue(AbstratRootBp rootBp) throws Exception {
        ModbusReadSingleInputBp bpData = new ModbusReadSingleInputBp();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ModbusReadSingleInputBp)) {
            return false;
        }
        ModbusReadSingleInputBp other = (ModbusReadSingleInputBp)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ModbusReadSingleInputBp;
    }
    ...
    public String toString() {
        return "ModbusReadSingleInputBp(windService=" + this.getWindService() + ", windTaskRecordMapper=" + this.getWindTaskRecordMapper() + ", ipModbusHost=" + this.getIpModbusHost() + ", ipModbusPort=" + this.getIpModbusPort() + ", ipCoilAddress=" + this.getIpCoilAddress() + ", ipSlaveId=" + this.getIpSlaveId() + ")";
    }
}
