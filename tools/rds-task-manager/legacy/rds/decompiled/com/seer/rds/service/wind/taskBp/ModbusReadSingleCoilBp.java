 ...
 *  com.seer.rds.service.wind.taskBp.ModbusReadSingleCoilBp
...
import com.seer.rds.vo.wind.ModbusReadSingleCoilBpField;
...
@Component(value="ModbusReadSingleCoilBp")
@Scope(value="prototype")
public class ModbusReadSingleCoilBp
extends AbstractBp {
    private static final Logger log = LoggerFactory.getLogger(ModbusReadSingleCoilBp.class);
    @Autowired
    ...
    protected void getInputParamsAndExecute(AbstratRootBp rootBp) throws Exception {
        this.ipModbusHost = String.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusReadSingleCoilBpField.ipModbusHost));
        this.ipModbusPort = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusReadSingleCoilBpField.ipModbusPort).toString());
        this.ipCoilAddress = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusReadSingleCoilBpField.ipCoilAddress).toString());
        this.ipSlaveId = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusReadSingleCoilBpField.ipSlaveId).toString());
        ...
        while (true) {
            try {
                ...
                modbusValue = Modbus4jUtils.readCoilStatus((String)this.ipModbusHost, (int)this.ipModbusPort, (int)this.ipSlaveId, (int)this.ipCoilAddress, (String)"ModbusReadSingleCoilBp");
            }
            catch (Exception e) {
                ...
                log.error("ModbusReadSingleCoilBp [{},{}] {}]", new Object[]{this.ipModbusHost, this.ipModbusPort, e});
                ...
                if (!modbusException) {
                    ...
                    this.windService.updateTaskRecordEndedReason(this.taskRecord.getId(), "[ModbusReadSingleCoilBp]modbus @{wind.bp.retry}");
                }
        ...
        log.info("ModbusReadSingleCoilBp " + message);
        ...
        childParamMap.put(ModbusReadSingleCoilBpField.ctxModbusValue, modbusValue);
    ...
    protected void setBlockInputParamsValue(AbstratRootBp rootBp) throws Exception {
        ModbusReadSingleCoilBp bpData = new ModbusReadSingleCoilBp();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ModbusReadSingleCoilBp)) {
            return false;
        }
        ModbusReadSingleCoilBp other = (ModbusReadSingleCoilBp)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ModbusReadSingleCoilBp;
    }
    ...
    public String toString() {
        return "ModbusReadSingleCoilBp(windService=" + this.getWindService() + ", windTaskRecordMapper=" + this.getWindTaskRecordMapper() + ", ipModbusHost=" + this.getIpModbusHost() + ", ipModbusPort=" + this.getIpModbusPort() + ", ipCoilAddress=" + this.getIpCoilAddress() + ", ipSlaveId=" + this.getIpSlaveId() + ")";
    }
}
