...
public class SetSiteEmptyBpInputVo {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SetSiteEmptyBpInputVo)) {
            return false;
        }
        SetSiteEmptyBpInputVo other = (SetSiteEmptyBpInputVo)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SetSiteEmptyBpInputVo;
    }
    ...
    public String toString() {
        return "SetSiteEmptyBpInputVo(siteId=" + this.getSiteId() + ")";
    }
}
