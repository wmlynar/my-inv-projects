 ...
 *  com.seer.rds.vo.UserReqVo$UserReqVoBuilder
 */
...
public class UserReqVo {
    ...
    public static UserReqVoBuilder builder() {
        return new UserReqVoBuilder();
    }
    ...
    public void setRoles(List<JSONObject> roles) {
        this.roles = roles;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserReqVo)) {
            return false;
        }
        UserReqVo other = (UserReqVo)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof UserReqVo;
    }
    ...
    public String toString() {
        return "UserReqVo(id=" + this.getId() + ", username=" + this.getUsername() + ", password=" + this.getPassword() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", roles=" + this.getRoles() + ", createTime=" + this.getCreateTime() + ", modifyTime=" + this.getModifyTime() + ")";
    }

    public UserReqVo() {
    }

    public UserReqVo(String id, String username, String password, Integer status, Integer type, List<JSONObject> roles, Date createTime, Date modifyTime) {
        this.id = id;
        this.username = username;
        this.password = password;
        this.status = status;
