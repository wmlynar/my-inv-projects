 ...
 *  com.seer.rds.service.wind.taskBp.ModbusBatchReadSingleCoilBp
...
import com.seer.rds.vo.wind.ModbusBatchReadSingleCoilBpField;
...
@Component(value="ModbusBatchReadSingleCoilBp")
@Scope(value="prototype")
public class ModbusBatchReadSingleCoilBp
extends AbstractBp {
    private static final Logger log = LoggerFactory.getLogger(ModbusBatchReadSingleCoilBp.class);
    @Autowired
    ...
    protected void getInputParamsAndExecute(AbstratRootBp rootBp) throws Exception {
        boolean[] modbusValue;
        this.ipModbusHost = String.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusBatchReadSingleCoilBpField.ipModbusHost));
        this.ipModbusPort = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusBatchReadSingleCoilBpField.ipModbusPort).toString());
        this.ipRegisterOffset = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusBatchReadSingleCoilBpField.ipRegisterOffset).toString());
        this.ipSlaveId = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusBatchReadSingleCoilBpField.ipSlaveId).toString());
        this.ipLength = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusBatchReadSingleCoilBpField.ipLength).toString());
        boolean modbusException = false;
        int socketExceptionCount = 0;
        while (true) {
            try {
                WindTaskStatus.monitorTaskEndErrorAndTaskStop((AbstractBp)this);
                modbusValue = Modbus4jUtils.batchReadCoils((String)this.ipModbusHost, (int)this.ipModbusPort, (int)this.ipSlaveId, (int)this.ipRegisterOffset, (int)this.ipLength, (String)"ModbusBatchReadSingleCoilBp");
            }
            catch (Exception e) {
                ...
                log.error("ModbusBatchReadSingleCoilBp [{},{}] {}]", new Object[]{this.ipModbusHost, this.ipModbusPort, e});
                ...
                if (!modbusException) {
                    ...
                    this.windService.updateTaskRecordEndedReason(this.taskRecord.getId(), "[ModbusBatchReadSingleCoilBp]modbus @{wind.bp.retry}");
                }
        ...
        log.info("ModbusBatchReadSingleCoilBp " + message);
    ...
    protected void setBlockInputParamsValue(AbstratRootBp rootBp) throws Exception {
        ModbusBatchReadSingleCoilBp bpData = new ModbusBatchReadSingleCoilBp();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ModbusBatchReadSingleCoilBp)) {
            return false;
        }
        ModbusBatchReadSingleCoilBp other = (ModbusBatchReadSingleCoilBp)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ModbusBatchReadSingleCoilBp;
    }
    ...
    public String toString() {
        return "ModbusBatchReadSingleCoilBp(windService=" + this.getWindService() + ", windTaskRecordMapper=" + this.getWindTaskRecordMapper() + ", ipModbusHost=" + this.getIpModbusHost() + ", ipModbusPort=" + this.getIpModbusPort() + ", ipRegisterOffset=" + this.getIpRegisterOffset() + ", ipSlaveId=" + this.getIpSlaveId() + ", ipLength=" + this.getIpLength() + ")";
    }
}
