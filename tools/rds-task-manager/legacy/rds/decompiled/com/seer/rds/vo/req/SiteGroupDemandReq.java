...
public class SiteGroupDemandReq {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SiteGroupDemandReq)) {
            return false;
        }
        SiteGroupDemandReq other = (SiteGroupDemandReq)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SiteGroupDemandReq;
    }
    ...
    public String toString() {
        return "SiteGroupDemandReq(id=" + this.getId() + ", status=" + this.getStatus() + ", fromGroup=" + this.getFromGroup() + ", toGroup=" + this.getToGroup() + ", groupName=" + this.getGroupName() + ", vehicleName=" + this.getVehicleName() + ", vehicleMaxNumber=" + this.getVehicleMaxNumber() + ")";
    }
}
