 ...
 *  com.seer.rds.service.wind.taskBp.ModbusBatchReadHoldingRegisterBp
...
@Component(value="ModbusBatchReadHoldingRegisterBp")
@Scope(value="prototype")
public class ModbusBatchReadHoldingRegisterBp
extends AbstractBp {
    private static final Logger log = LoggerFactory.getLogger(ModbusBatchReadHoldingRegisterBp.class);
    @Autowired
    ...
    protected void getInputParamsAndExecute(AbstratRootBp rootBp) throws Exception {
        short[] modbusValue;
        this.ipModbusHost = String.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusBatchReadHoldingRegisterBpField.ipModbusHost));
        this.ipModbusPort = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusBatchReadHoldingRegisterBpField.ipModbusPort).toString());
        this.ipRegisterOffset = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusBatchReadHoldingRegisterBpField.ipRegisterOffset).toString());
        this.ipSlaveId = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusBatchReadHoldingRegisterBpField.ipSlaveId).toString());
        this.ipLength = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusBatchReadHoldingRegisterBpField.ipLength).toString());
        boolean modbusException = false;
        int socketExceptionCount = 0;
        while (true) {
            try {
                WindTaskStatus.monitorTaskEndErrorAndTaskStop((AbstractBp)this);
                modbusValue = Modbus4jUtils.batchReadHoldingRegisters((String)this.ipModbusHost, (int)this.ipModbusPort, (int)this.ipSlaveId, (int)this.ipRegisterOffset, (int)this.ipLength, (String)"ModbusBatchReadHoldingRegisterBp");
            }
            catch (Exception e) {
                ...
                log.error("ModbusBatchReadHoldingRegisterBp [{},{}] {}]", new Object[]{this.ipModbusHost, this.ipModbusPort, e});
                ...
                if (!modbusException) {
                    ...
                    this.windService.updateTaskRecordEndedReason(this.taskRecord.getId(), "[ModbusBatchReadHoldingRegisterBp]modbus @{wind.bp.retry}");
                }
        ...
        log.info("ModbusBatchReadHoldingRegisterBp " + message);
    ...
    protected void setBlockInputParamsValue(AbstratRootBp rootBp) throws Exception {
        ModbusBatchReadHoldingRegisterBp bpData = new ModbusBatchReadHoldingRegisterBp();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ModbusBatchReadHoldingRegisterBp)) {
            return false;
        }
        ModbusBatchReadHoldingRegisterBp other = (ModbusBatchReadHoldingRegisterBp)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ModbusBatchReadHoldingRegisterBp;
    }
    ...
    public String toString() {
        return "ModbusBatchReadHoldingRegisterBp(windService=" + this.getWindService() + ", windTaskRecordMapper=" + this.getWindTaskRecordMapper() + ", ipModbusHost=" + this.getIpModbusHost() + ", ipModbusPort=" + this.getIpModbusPort() + ", ipRegisterOffset=" + this.getIpRegisterOffset() + ", ipSlaveId=" + this.getIpSlaveId() + ", ipLength=" + this.getIpLength() + ")";
    }
}
