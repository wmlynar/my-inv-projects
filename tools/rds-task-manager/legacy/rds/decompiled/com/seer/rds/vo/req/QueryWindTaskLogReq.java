...
public class QueryWindTaskLogReq {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof QueryWindTaskLogReq)) {
            return false;
        }
        QueryWindTaskLogReq other = (QueryWindTaskLogReq)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof QueryWindTaskLogReq;
    }
    ...
    public String toString() {
        return "QueryWindTaskLogReq(taskRecordId=" + this.getTaskRecordId() + ")";
    }
}
