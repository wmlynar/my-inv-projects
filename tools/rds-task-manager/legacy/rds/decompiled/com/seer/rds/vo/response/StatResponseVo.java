 ...
 *  com.seer.rds.vo.response.StatResponseVo$StatResponseVoBuilder
 */
...
public class StatResponseVo {
    private String date;
    private BigDecimal total;
    private BigDecimal average;
    private String type;
    private List<StatRecordVo> statRecordVos;

    public static StatResponseVoBuilder builder() {
        return new StatResponseVoBuilder();
    }
    ...
    public List<StatRecordVo> getStatRecordVos() {
    ...
    public void setStatRecordVos(List<StatRecordVo> statRecordVos) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StatResponseVo)) {
            return false;
        }
        StatResponseVo other = (StatResponseVo)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof StatResponseVo;
    }
    ...
    public String toString() {
        return "StatResponseVo(date=" + this.getDate() + ", total=" + this.getTotal() + ", average=" + this.getAverage() + ", type=" + this.getType() + ", statRecordVos=" + this.getStatRecordVos() + ")";
    }

    public StatResponseVo() {
    }

    public StatResponseVo(String date, BigDecimal total, BigDecimal average, String type, List<StatRecordVo> statRecordVos) {
        this.date = date;
        this.total = total;
        this.average = average;
        this.type = type;
