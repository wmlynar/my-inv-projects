 ...
 *  com.seer.rds.service.wind.taskBp.ModbusSetSingleRegisterBp
...
import com.seer.rds.vo.wind.ModbusSetSingleRegisterBpField;
...
@Component(value="ModbusSetSingleRegisterBp")
@Scope(value="prototype")
public class ModbusSetSingleRegisterBp
extends AbstractBp {
    private static final Logger log = LoggerFactory.getLogger(ModbusSetSingleRegisterBp.class);
    @Autowired
    ...
    protected void getInputParamsAndExecute(AbstratRootBp rootBp) throws Exception {
        this.ipModbusHost = String.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusSetSingleRegisterBpField.ipModbusHost));
        this.ipModbusPort = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusSetSingleRegisterBpField.ipModbusPort).toString());
        this.ipRegisterAddress = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusSetSingleRegisterBpField.ipRegisterAddress).toString());
        this.ipSlaveId = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusSetSingleRegisterBpField.ipSlaveId).toString());
        this.ipRegisterData = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusSetSingleRegisterBpField.ipRegisterData).toString());
        boolean modbusException = false;
        int socketExceptionCount = 0;
        while (true) {
            try {
                WindTaskStatus.monitorTaskEndErrorAndTaskStop((AbstractBp)this);
                Modbus4jUtils.writeHoldingRegister((String)this.ipModbusHost, (int)this.ipModbusPort, (int)this.ipSlaveId, (int)this.ipRegisterAddress, (int)2, (Object)this.ipRegisterData, (String)"ModbusSetSingleRegisterBp");
            }
            catch (Exception e) {
                ...
                log.error("ModbusSetSingleRegisterBp [{},{}] {}]", new Object[]{this.ipModbusHost, this.ipModbusPort, e});
                ...
                if (!modbusException) {
                    ...
                    this.windService.updateTaskRecordEndedReason(this.taskRecord.getId(), "[ModbusSetSingleRegisterBp]modbus @{wind.bp.retry}");
                }
        ...
        log.info("ModbusSetSingleRegisterBp " + message);
    }

    protected void setBlockInputParamsValue(AbstratRootBp rootBp) throws Exception {
        ModbusSetSingleRegisterBp bpData = new ModbusSetSingleRegisterBp();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ModbusSetSingleRegisterBp)) {
            return false;
        }
        ModbusSetSingleRegisterBp other = (ModbusSetSingleRegisterBp)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ModbusSetSingleRegisterBp;
    }
    ...
    public String toString() {
        return "ModbusSetSingleRegisterBp(windService=" + this.getWindService() + ", windTaskRecordMapper=" + this.getWindTaskRecordMapper() + ", ipModbusHost=" + this.getIpModbusHost() + ", ipModbusPort=" + this.getIpModbusPort() + ", ipRegisterAddress=" + this.getIpRegisterAddress() + ", ipSlaveId=" + this.getIpSlaveId() + ", ipRegisterData=" + this.getIpRegisterData() + ")";
    }
}
