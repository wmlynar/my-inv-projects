...
public class ModbusCommonWriteBpInput {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ModbusCommonWriteBpInput)) {
            return false;
        }
        ModbusCommonWriteBpInput other = (ModbusCommonWriteBpInput)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ModbusCommonWriteBpInput;
    }
    ...
    public String toString() {
        return "ModbusCommonWriteBpInput(addrType=" + this.getAddrType() + ", ipModbusHost=" + this.getIpModbusHost() + ", ipModbusPort=" + this.getIpModbusPort() + ", ipSlaveId=" + this.getIpSlaveId() + ", ipAddress=" + this.getIpAddress() + ", newValue=" + this.getNewValue() + ")";
    }
}
