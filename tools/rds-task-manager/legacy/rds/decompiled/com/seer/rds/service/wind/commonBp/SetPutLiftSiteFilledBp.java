 ...
 *  com.seer.rds.service.wind.commonBp.SetPutLiftSiteFilledBp
...
@Component(value="SetPutLiftSiteFilledBp")
@Scope(value="prototype")
@Deprecated
public class SetPutLiftSiteFilledBp
extends AbstractBp {
    private static final Logger log = LoggerFactory.getLogger(SetPutLiftSiteFilledBp.class);
    @Autowired
    ...
    protected void getInputParamsAndExecute(AbstratRootBp rootBp) throws Exception {
        ...
        String pickSiteId = (String)CallLiftBp.siteMap.get(this.siteId.toString());
        ...
        List allByPickSiteLabel = this.workSiteMapper.findBySiteId(pickSiteId.toString());
        if (allByPickSiteLabel.size() == 0) {
            throw new Exception(String.format("@{wind.bp.siteNot}:%s", pickSiteId));
        }
        this.workSiteMapper.updateSiteFillStatusBySiteId(this.siteId.toString(), Integer.valueOf(SiteStatusEnum.filled.getStatus()));
        this.workSiteMapper.updateSiteFillStatusBySiteId(pickSiteId, Integer.valueOf(SiteStatusEnum.filled.getStatus()));
        String taskRecordId = this.taskRecord.getId();
        this.workSiteMapper.updateLockedSiteToUnlockByLockedBy(pickSiteId, taskRecordId);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SetPutLiftSiteFilledBp)) {
            return false;
        }
        SetPutLiftSiteFilledBp other = (SetPutLiftSiteFilledBp)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SetPutLiftSiteFilledBp;
    }
    ...
    public String toString() {
        return "SetPutLiftSiteFilledBp(windService=" + this.getWindService() + ", workSiteMapper=" + this.getWorkSiteMapper() + ", liftRecordMapper=" + this.getLiftRecordMapper() + ", siteId=" + this.getSiteId() + ")";
    }
}
