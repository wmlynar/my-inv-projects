 ...
 *  com.seer.rds.service.wind.commonBp.SetSiteFilledBp
...
@Component(value="SetSiteFilledBp")
@Scope(value="prototype")
public class SetSiteFilledBp
extends AbstractBp {
    private static final Logger log = LoggerFactory.getLogger(SetSiteFilledBp.class);
    @Autowired
    ...
    protected void getInputParamsAndExecute(AbstratRootBp rootBp) throws Exception {
        this.siteIdObj = rootBp.getInputParamValue(this.taskId, this.inputParams, SetSiteFilledBpField.siteId);
        log.info("SetSiteFilledBp siteId=" + this.siteIdObj);
        ...
        this.workSiteMapper.updateSiteFillStatusBySiteId(this.siteIdObj.toString(), Integer.valueOf(SiteStatusEnum.filled.getStatus()));
    }

    protected void setBlockInputParamsValue(AbstratRootBp rootBp) {
        SetSiteFilledBp bpData = new SetSiteFilledBp();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SetSiteFilledBp)) {
            return false;
        }
        SetSiteFilledBp other = (SetSiteFilledBp)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SetSiteFilledBp;
    }
    ...
    public String toString() {
        return "SetSiteFilledBp(windService=" + this.getWindService() + ", workSiteMapper=" + this.getWorkSiteMapper() + ", siteIdObj=" + this.getSiteIdObj() + ")";
    }
}
