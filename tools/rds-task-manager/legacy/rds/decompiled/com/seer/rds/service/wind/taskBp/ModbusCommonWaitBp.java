 ...
 *  com.seer.rds.service.wind.taskBp.ModbusCommonWaitBp
...
@Component(value="ModbusCommonWaitBp")
@Scope(value="prototype")
public class ModbusCommonWaitBp
extends AbstractBp {
    private static final Logger log = LoggerFactory.getLogger(ModbusCommonWaitBp.class);
    @Autowired
    ...
    private Integer ipRegisterData;
    ...
    protected void getInputParamsAndExecute(AbstratRootBp rootBp) throws Exception {
        ...
        this.addrType = String.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusCommonWaitBpField.addrType));
        this.ipModbusHost = String.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusCommonWaitBpField.ipModbusHost));
        this.ipModbusPort = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusCommonWaitBpField.ipModbusPort).toString());
        this.ipAddress = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusCommonWaitBpField.ipAddress).toString());
        this.ipSlaveId = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusCommonWaitBpField.ipSlaveId).toString());
        this.ipRegisterData = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusCommonWaitBpField.ipRegisterData).toString());
        this.alias = "";
        ...
        message.append("ipModbusHost=").append(this.ipModbusHost).append(",ipModbusPort=").append(this.ipModbusPort).append(",ipAddress=").append(this.ipAddress).append(",ipSlaveId=").append(this.ipSlaveId).append(",addrType=").append(this.addrType).append(",ipRegisterData=").append(this.ipRegisterData).append(",alias=").append(this.alias);
        log.info("ModbusCommonWaitBp " + message);
        ...
        while (true) {
            try {
                ...
                if (this.ipRegisterData.equals(modbusValue)) {
                    log.info("status: {}, coilStatus: {}", (Object)modbusValue, (Object)this.ipRegisterData);
                    break;
                }
                ...
                if (modbusException) {
                    ...
                    this.windService.saveBlockRecord(this.blockRecord, this.blockVo.getBlockId(), this.blockVo.getBlockType(), this.taskRecord.getProjectId(), this.taskId, this.taskRecord.getId(), this.startOn);
                    this.windService.updateTaskRecordEndedReason(this.taskRecord.getId(), "[ModbusCommonWaitBp]modbus@{wind.bp.retry}");
                }
                ...
                log.error("ModbusCommonWaitBp [{},{}] {}]", new Object[]{this.ipModbusHost, this.ipModbusPort, e});
    ...
    protected void setBlockInputParamsValue(AbstratRootBp rootBp) throws Exception {
        ModbusCommonWaitBp bpData = new ModbusCommonWaitBp();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ModbusCommonWaitBp)) {
            return false;
        }
        ModbusCommonWaitBp other = (ModbusCommonWaitBp)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ModbusCommonWaitBp;
    }
    ...
    public String toString() {
        return "ModbusCommonWaitBp(windService=" + this.getWindService() + ", windTaskRecordMapper=" + this.getWindTaskRecordMapper() + ", addrType=" + this.getAddrType() + ", ipModbusHost=" + this.getIpModbusHost() + ", ipModbusPort=" + this.getIpModbusPort() + ", ipAddress=" + this.getIpAddress() + ", ipSlaveId=" + this.getIpSlaveId() + ", alias=" + this.getAlias() + ", ipRegisterData=" + this.getIpRegisterData() + ")";
    }
}
