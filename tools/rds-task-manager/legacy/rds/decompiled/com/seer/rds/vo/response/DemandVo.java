...
public class DemandVo {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DemandVo)) {
            return false;
        }
        DemandVo other = (DemandVo)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DemandVo;
    }
    ...
    public String toString() {
        return "DemandVo(id=" + this.getId() + ", defLabel=" + this.getDefLabel() + ", description=" + this.getDescription() + ", createdOn=" + this.getCreatedOn() + ", content=" + this.getContent() + ")";
    }
}
