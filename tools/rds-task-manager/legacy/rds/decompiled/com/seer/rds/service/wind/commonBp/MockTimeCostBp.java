 ...
 *  com.seer.rds.service.wind.commonBp.MockTimeCostBp
 *  com.seer.rds.vo.wind.MockTimeCostBpField
 *  org.slf4j.Logger
...
import com.seer.rds.vo.wind.MockTimeCostBpField;
...
@Component(value="MockTimeCostBp")
@Scope(value="prototype")
public class MockTimeCostBp
extends AbstractBp {
    private static final Logger log = LoggerFactory.getLogger(MockTimeCostBp.class);
    ...
    protected void getInputParamsAndExecute(AbstratRootBp rootBp) throws Exception {
        Object timeMillis = rootBp.getInputParamValue(this.taskId, this.inputParams, MockTimeCostBpField.timeMillis);
        this.longtimeMillis = timeMillis != null ? Long.parseLong(timeMillis.toString()) : 0L;
        Thread.sleep(this.longtimeMillis);
    }

    protected void setBlockInputParamsValue(AbstratRootBp rootBp) throws Exception {
        MockTimeCostBp bpData = new MockTimeCostBp();
        bpData.setTimeMillis(Long.valueOf(this.longtimeMillis));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MockTimeCostBp)) {
            return false;
        }
        MockTimeCostBp other = (MockTimeCostBp)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MockTimeCostBp;
    }
    ...
    public String toString() {
        return "MockTimeCostBp(timeMillis=" + this.getTimeMillis() + ", windService=" + this.getWindService() + ", longtimeMillis=" + this.getLongtimeMillis() + ")";
    }
}
