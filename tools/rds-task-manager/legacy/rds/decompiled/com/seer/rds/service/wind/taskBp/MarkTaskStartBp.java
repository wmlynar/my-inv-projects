 ...
 *  com.seer.rds.service.wind.taskBp.MarkTaskStartBp
 *  org.slf4j.Logger
...
@Component(value="MarkTaskStartBp")
@Scope(value="prototype")
public class MarkTaskStartBp
extends AbstractBp {
    private static final Logger log = LoggerFactory.getLogger(MarkTaskStartBp.class);
    @Autowired
    private WindService windService;

    protected void getInputParamsAndExecute(AbstratRootBp rootBp) throws Exception {
        this.windService.saveLog(TaskLogLevelEnum.info.getLevel(), "[MarkTaskStartBp]@{wind.bp.start}", this.taskRecord.getProjectId(), this.taskId, this.taskRecord.getId(), this.blockVo.getBlockId());
        RootBp.taskStatus.put(this.taskId + this.taskRecord.getId(), true);
    }
