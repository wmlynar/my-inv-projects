 ...
 *  com.seer.rds.service.wind.taskBp.ModbusReadInputRegisterBp
 *  com.seer.rds.vo.wind.ModbusReadInputRegisterBpField
...
import com.seer.rds.vo.wind.ModbusReadInputRegisterBpField;
...
@Component(value="ModbusReadInputRegisterBp")
@Scope(value="prototype")
public class ModbusReadInputRegisterBp
extends AbstractBp {
    private static final Logger log = LoggerFactory.getLogger(ModbusReadInputRegisterBp.class);
    @Autowired
    ...
    protected void getInputParamsAndExecute(AbstratRootBp rootBp) throws Exception {
        this.ipModbusHost = String.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusReadInputRegisterBpField.ipModbusHost));
        this.ipModbusPort = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusReadInputRegisterBpField.ipModbusPort).toString());
        this.ipRegisterAddress = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusReadInputRegisterBpField.ipRegisterAddress).toString());
        this.ipSlaveId = Integer.valueOf(rootBp.getInputParamValue(this.taskId, this.inputParams, ModbusReadInputRegisterBpField.ipSlaveId).toString());
        ...
        while (true) {
            try {
                ...
                modbusValue = Modbus4jUtils.readInputRegister((String)this.ipModbusHost, (int)this.ipModbusPort, (int)this.ipSlaveId, (int)this.ipRegisterAddress, (int)2, (String)"ModbusReadInputRegisterBp");
            }
            catch (Exception e) {
                ...
                log.error("ModbusReadInputRegisterBp [{},{}] {}]", new Object[]{this.ipModbusHost, this.ipModbusPort, e});
                ...
                if (!modbusException) {
                    ...
                    this.windService.updateTaskRecordEndedReason(this.taskRecord.getId(), "[ModbusReadInputRegisterBp]modbus @{wind.bp.retry}");
                }
        ...
        message.append("ipModbusHost=").append(this.ipModbusHost).append(",ipModbusPort=").append(this.ipModbusPort).append(",ipRegisterAddress=").append(this.ipRegisterAddress).append(",ipSlaveId=").append(this.ipSlaveId).append(",value=").append(modbusValue);
        this.saveLogResult((Object)modbusValue);
        log.info("ModbusReadInputRegisterBp " + message);
        ...
        childParamMap.put(ModbusReadInputRegisterBpField.ctxModbusValue, modbusValue);
    ...
    protected void setBlockInputParamsValue(AbstratRootBp rootBp) throws Exception {
        ModbusReadInputRegisterBp bpData = new ModbusReadInputRegisterBp();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ModbusReadInputRegisterBp)) {
            return false;
        }
        ModbusReadInputRegisterBp other = (ModbusReadInputRegisterBp)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ModbusReadInputRegisterBp;
    }
    ...
    public String toString() {
        return "ModbusReadInputRegisterBp(windService=" + this.getWindService() + ", windTaskRecordMapper=" + this.getWindTaskRecordMapper() + ", ipModbusHost=" + this.getIpModbusHost() + ", ipModbusPort=" + this.getIpModbusPort() + ", ipRegisterAddress=" + this.getIpRegisterAddress() + ", ipSlaveId=" + this.getIpSlaveId() + ")";
    }
}
