...
public class WindTaskDefExport
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WindTaskDefExport)) {
            return false;
        }
        WindTaskDefExport other = (WindTaskDefExport)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof WindTaskDefExport;
    }
    ...
    public String toString() {
        return "WindTaskDefExport(id=" + this.getId() + ", projectId=" + this.getProjectId() + ", detail=" + this.getDetail() + ", version=" + this.getVersion() + ", label=" + this.getLabel() + ", status=" + this.getStatus() + ", remark=" + this.getRemark() + ", templateDescription=" + this.getTemplateDescription() + ", templateName=" + this.getTemplateName() + ", periodicTask=" + this.getPeriodicTask() + ", ifEnable=" + this.getIfEnable() + ", period=" + this.getPeriod() + ", delay=" + this.getDelay() + ", windcategoryId=" + this.getWindcategoryId() + ")";
    }
}
