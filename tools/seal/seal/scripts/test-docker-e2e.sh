...
CONFIG_ENV="${SEAL_E2E_CONFIG:-}"
if [ -n "$CONFIG_ENV" ]; then
  if [[ "$CONFIG_ENV" != /* ]]; then
    CONFIG_ENV="/workspace/$CONFIG_ENV"
  elif [[ "$CONFIG_ENV" == "$REPO_ROOT/"* ]]; then
    CONFIG_ENV="/workspace/${CONFIG_ENV#$REPO_ROOT/}"
  elif [[ "$CONFIG_ENV" != "/workspace/"* ]]; then
    log "WARN: SEAL_E2E_CONFIG not under repo root; not passing into container."
    CONFIG_ENV=""
  fi
fi
$DOCKER run --rm \
  ...
  -e SEAL_E2E_CAPS_ALLOW="${SEAL_E2E_CAPS_ALLOW:-}" \
  -e SEAL_E2E_CAPS_DENY="${SEAL_E2E_CAPS_DENY:-}" \
  -e SEAL_E2E_DOCKER_HOST="${SEAL_E2E_DOCKER_HOST:-}" \
  -e SEAL_E2E_REQUIRE_ESCALATION="${SEAL_E2E_REQUIRE_ESCALATION:-}" \
  ...
  -e SEAL_E2E_PLAN="${SEAL_E2E_PLAN:-}" \
  -e SEAL_E2E_EXPLAIN="${SEAL_E2E_EXPLAIN:-}" \
  -e SEAL_E2E_SETUP_ONLY="${SEAL_E2E_SETUP_ONLY:-}" \
  ...
  -e SEAL_UI_E2E_TRACE="${SEAL_UI_E2E_TRACE:-}" \
  -e SEAL_UI_E2E_ARTIFACTS="${SEAL_UI_E2E_ARTIFACTS:-}" \
  ...
  -e SEAL_E2E_INSTALL_EXAMPLE_DEPS="${SEAL_E2E_INSTALL_EXAMPLE_DEPS:-}" \
  -e SEAL_E2E_COPY_EXAMPLE="${SEAL_E2E_COPY_EXAMPLE:-}" \
  -e SEAL_E2E_EXAMPLE_ROOT="${SEAL_E2E_EXAMPLE_ROOT:-}" \
  -e SEAL_E2E_TIMEOUT_SCALE="${SEAL_E2E_TIMEOUT_SCALE:-}" \
  -e SEAL_E2E_SLOW="${SEAL_E2E_SLOW:-}" \
  -e SEAL_E2E_SPAWN_TIMEOUT_MS="${SEAL_E2E_SPAWN_TIMEOUT_MS:-}" \
  ...
  -e SEAL_E2E_STRICT_SYSLOG="${SEAL_E2E_STRICT_SYSLOG:-0}" \
  -e SEAL_E2E_STRICT_SYSCTL="${SEAL_E2E_STRICT_SYSCTL:-0}" \
  -e SEAL_E2E_STRICT_DMESG="${SEAL_E2E_STRICT_DMESG:-0}" \
  -e SEAL_E2E_STRICT_DYNLINK="${SEAL_E2E_STRICT_DYNLINK:-0}" \
  -e SEAL_E2E_STRICT_ENV_SCRUB_EXT="${SEAL_E2E_STRICT_ENV_SCRUB_EXT:-0}" \
  -e SEAL_E2E_STRICT_LD_SO_PRELOAD="${SEAL_E2E_STRICT_LD_SO_PRELOAD:-0}" \
  -e SEAL_E2E_STRICT_NODE_MEMFD="${SEAL_E2E_STRICT_NODE_MEMFD:-0}" \
  -e SEAL_E2E_STRICT_BOOTSTRAP_PAGE_COUNT="${SEAL_E2E_STRICT_BOOTSTRAP_PAGE_COUNT:-0}" \
  -e SEAL_E2E_STRICT_BOOTSTRAP_SELF_SCAN="${SEAL_E2E_STRICT_BOOTSTRAP_SELF_SCAN:-0}" \
  -e SEAL_E2E_STRICT_BOOTSTRAP_SELF_SCAN_VMFLAGS="${SEAL_E2E_STRICT_BOOTSTRAP_SELF_SCAN_VMFLAGS:-0}" \
  -e SEAL_E2E_STRICT_BOOTSTRAP_MARKER="${SEAL_E2E_STRICT_BOOTSTRAP_MARKER:-0}" \
  -e SEAL_E2E_STRICT_BOOTSTRAP_WIPE="${SEAL_E2E_STRICT_BOOTSTRAP_WIPE:-0}" \
  -e SEAL_E2E_STRICT_BOOTSTRAP_TOKENS="${SEAL_E2E_STRICT_BOOTSTRAP_TOKENS:-0}" \
  -e SEAL_E2E_STRICT_ATTACH_BASELINE="${SEAL_E2E_STRICT_ATTACH_BASELINE:-0}" \
  -e SEAL_E2E_STRICT_TOOL_BASELINE="${SEAL_E2E_STRICT_TOOL_BASELINE:-0}" \
  -e SEAL_E2E_STRICT_HOST_BASELINE="${SEAL_E2E_STRICT_HOST_BASELINE:-0}" \
  -e SEAL_E2E_STRICT_CORE_BASELINE="${SEAL_E2E_STRICT_CORE_BASELINE:-0}" \
  -e SEAL_E2E_REAL_DUMP="${SEAL_E2E_REAL_DUMP:-0}" \
  -e SEAL_E2E_STRICT_REAL_DUMP="${SEAL_E2E_STRICT_REAL_DUMP:-0}" \
  "${NODE_MODULES_ENV[@]}" \
  "${SHIP_ENV_ARGS[@]}" \
  "$BUILDER_IMAGE" \
