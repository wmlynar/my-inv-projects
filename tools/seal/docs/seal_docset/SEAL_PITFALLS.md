...
- Blad: `rsync`/`scp`/`ssh` dziedziczyly `RSYNC_RSH`/`GIT_SSH_COMMAND`/`SSH_CONFIG` z srodowiska, co nadpisywalo nasze opcje (ProxyCommand/ControlPath) i psulo deterministycznosc.
