...
- Dodac testy jednostkowe geometrii (bounds/projection/hit-test).
- Dodac prosty logger (`debug('map-core', ...)`) i stosowac w krytycznych modulach.

## 18) Konkretna sciezka refaktoru (krok po kroku)
