<!-- PODZIAŁ KOMPONENTOWY v0.3: CZĘŚĆ A — Fleet Core (+ wspólne kontrakty) -->
...
> **Uwaga (podział komponentowy):** pozostałe komponenty opisane w sekcji 3.4 są w osobnych plikach (Fleet Gateway oraz Integracje/Narzędzia).
