# Fleet Manager 2.0 — Specyfikacja UI / Mock UI (v0.2)
...
## DOKUMENT: Specyfikacja UI / Mock UI (v0.2)
...
#### 0.2 Zmiany względem v0.1 (changelog skrócony)
...
## 22. Checklist implementacyjny (v0.2)
...
## 23. Rzeczy usunięte / zdezaktualizowane (archiwum v0.1)

Ta sekcja istnieje po to, żeby nic z v0.1 nie „zniknęło”, ale żeby w v0.2 nie mieszało się z kanonicznymi decyzjami.
